...
public class SpittleControllerTest {
	...
	@Test
	  public void shouldShowRecentSpittles() throws Exception {
	   ...
	   //     .thenReturn(expectedSpittles);
	    ...
	    MockMvc mockMvc = standaloneSetup(controller)
	        .setSingleView(new InternalResourceView("/WEB-INF/pages/spittles.jsp"))
	        .build();
	  ...
	  public void testSpittle() throws Exception {
	    ...
	    SpittleRepository mockRepository = mock(SpittleRepository.class);
	    when(mockRepository.getOne(12345L)).thenReturn(expectedSpittle);
	  ...
	  public void saveSpittle() throws Exception {
	    ...
	    verify(mockRepository, atLeastOnce()).save(new Spittle(null, "Hello World", null, -81.5811668, 28.4159649));
	  }
